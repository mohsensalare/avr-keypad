...
_0x0:
	.DB  0x45,0x52,0x52,0x4F,0x52,0x0,0x25,0x64
	.DB  0x0,0x20,0x0,0x25,0x64,0x20,0x2A,0x20
	.DB  0x0,0x25,0x64,0x20,0x2A,0x20,0x25,0x64
	.DB  0x0,0x25,0x64,0x20,0x2A,0x20,0x25,0x64
...
; 0000 0028             PORTC=port_map[row];
	LDI  R26,LOW(_port_map)
	LDI  R27,HIGH(_port_map)
	ADD  R26,R4
	ADC  R27,R5
	LD   R30,X
	OUT  0x15,R30
...
; 0000 0037                 return key_map[row][col];
	MOVW R30,R4
	LDI  R26,LOW(_key_map)
	LDI  R27,HIGH(_key_map)
	CALL __LSLW2
	ADD  R30,R26
	ADC  R31,R27
	ADD  R30,R6
